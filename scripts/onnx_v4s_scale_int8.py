...
def quantize_v4s_scale_onnx_int8(model_path, calib_path, output_path):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Lithotheque V4S Scale ONNX INT8 Quantizer")
    ...
    parser.add_argument("--out", type=str, default="echelle_v4s_int8.onnx", help="Output path")
    args = parser.parse_args()
    
    if os.path.exists(args.model):
        quantize_v4s_scale_onnx_int8(args.model, args.calib, args.out)
    else:
