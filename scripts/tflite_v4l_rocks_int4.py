...
def quantize_v4l_rocks_int4(model_path, calib_path, output_path):
    """
    Quantization script for MobileNetV4-Large (Rocks) - W4A8 (INT4 Weights).
    Standard NHWC alignment.
    """
    ...
    print("Exporting MobileNetV4-Large Rocks to W4A8 (INT4) TFLite...")
    quantizer.export(
        output_path,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Lithotheque V4L Rocks INT4 Quantizer")
    ...
    parser.add_argument("--out", type=str, default="roches_v4l_int4.tflite", help="Output path")
    args = parser.parse_args()
    
    if os.path.exists(args.model):
        quantize_v4l_rocks_int4(args.model, args.calib, args.out)
    else:
