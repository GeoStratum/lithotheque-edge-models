...
def quantize_v4l_rocks_onnx_int4(model_path, calib_path, output_path):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Lithotheque V4L Rocks ONNX INT4 Quantizer")
    ...
    parser.add_argument("--out", type=str, default="roches_v4l_int4.onnx", help="Output path")
    args = parser.parse_args()
    
    if os.path.exists(args.model):
        quantize_v4l_rocks_onnx_int4(args.model, args.calib, args.out)
    else:
