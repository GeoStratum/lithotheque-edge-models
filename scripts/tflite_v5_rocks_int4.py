...
def quantize_v5_rocks_int4(model_path, calib_path, output_path):
    """
    Advanced quantization script for MobileNetV5-300M (Rocks) - W4A8.
    Optimized for NPU with Frozen Graph strategy and ai-edge-quantizer compression.
    """
    temp_sm = "temp_v5_sm_int4"
    temp_float = "temp_v5_float_int4.tflite"
    ...
    # Step 2: Quantize with ai-edge-quantizer (W4A8)
    print(f"Quantizing to INT4 (W4A8): {output_path}")
    ...
    print(f"Successfully saved INT4 model to {output_path}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out", type=str, default="roches_v5_int4_noflex.tflite", help="Output path")
